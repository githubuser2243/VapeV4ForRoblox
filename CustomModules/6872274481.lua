...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/githubuser2243/VapeV4ForRoblox/main/"..scripturl, true)
	end
end
...
task.spawn(function()
	local url = "https://raw.githubusercontent.com/githubuser2243/VapeV4ForRoblox/main/CustomModules/bedwarsdata"
